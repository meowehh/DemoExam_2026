...
- Сведения о туннеле занесите в отчёт. (Отчет будет приложен отдельным [файлом](./report_2026.docx))
...
- Сведения о настройке и защите протокола занесите в отчёт. ([Отдельный файл](./report_2026.docx))
